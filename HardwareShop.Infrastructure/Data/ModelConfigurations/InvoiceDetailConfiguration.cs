...
namespace HardwareShop.Infrastructure.ModelConfigurations
{
    public sealed class InvoiceDetailConfiguration : IEntityTypeConfiguration<InvoiceDetail>
    {
        ...
        public void Configure(EntityTypeBuilder<InvoiceDetail> m)
        {
            ...
            _ = m.HasKey(e => e.Id);
            _ = m.HasOne(e => e.Invoice).WithMany(e => e.Details).HasForeignKey(e => e.InvoiceId).OnDelete(DeleteBehavior.Restrict);
            _ = m.HasOne(e => e.Product).WithMany(e => e.InvoiceDetails).HasForeignKey(e => e.ProductId).OnDelete(DeleteBehavior.Restrict);
